...
export const translations = {
  id: {
    ...
    classroom: {
      ...
      lessonOf: 'Pelajaran',
      from: 'dari',
      pipTitle: 'Picture-in-Picture & Jendela Mengambang',
      pipNative: 'Picture-in-Picture (OS)',
      floatingWindow: 'Jendela Mengambang',
      minimizeToFloating: 'Kecilkan ke Jendela Mengambang',
      expandPlayer: 'Perbesar Pemutar',
      closePlayer: 'Tutup Pemutar',
      stickyNoteTitle: 'Catatan Tempel',
      closeStickyNote: 'Tutup Catatan',
      notePeeling: 'Catatan terlepas',
    },
    ...
    myLearning: {
      ...
      // Notes feature
      notesTitle: 'Catatan Pembelajaran',
      notesSubtitle: 'Kumpulan catatan penting yang Anda buat selama menyimak materi video.',
      tabCourses: 'Kursus Berjalan',
      tabNotes: 'Catatan Pembelajaran',
      allNotesCount: 'Total Catatan',
      btnViewNotes: 'Lihat Catatan Pembelajaran',
      btnBackToCourses: 'Kembali ke Kursus',
      videoNumber: 'Video ke-',
      module: 'Modul',
      playAt: 'Tonton di',
      deleteNote: 'Hapus Catatan',
      deleteConfirm: 'Hapus catatan ini?',
      noNotesYet: 'Belum Ada Catatan Pembelajaran',
      noNotesYetDesc: 'Saat menonton video materi, klik tombol icon catatan di samping Fullscreen untuk menyimpan ringkasan atau poin penting.',
      searchNotesPlaceholder: 'Cari catatan atau topik materi...',
    },
    // Settings View & Tabs
    settings: {
      title: 'Pengaturan',
  ...
  en: {
    ...
    classroom: {
      ...
      lessonOf: 'Lesson',
      from: 'of',
      pipTitle: 'Picture-in-Picture & Floating Window',
      pipNative: 'Picture-in-Picture (OS)',
      floatingWindow: 'Floating Miniplayer',
      minimizeToFloating: 'Minimize to Floating Window',
      expandPlayer: 'Expand Player',
      closePlayer: 'Close Player',
      stickyNoteTitle: 'Sticky Note',
      closeStickyNote: 'Close Note',
      notePeeling: 'Note detached',
    },
    // Course Completion View
    completion: {
    ...
    myLearning: {
      ...
      notesSubtitle: 'All key notes and insights you captured while watching lesson videos.',
      tabCourses: 'Active Courses',
      tabNotes: 'Learning Notes',
      allNotesCount: 'Total Notes',
      btnViewNotes: 'View Learning Notes',
      btnBackToCourses: 'Back to Courses',
      videoNumber: 'Video #',
      module: 'Module',
      playAt: 'Play at',
      deleteNote: 'Delete Note',
      deleteConfirm: 'Delete this note?',
      noNotesYet: 'No Learning Notes Yet',
      noNotesYetDesc: 'While watching a video lesson, click the note icon next to Fullscreen to bookmark important takeaways.',
      searchNotesPlaceholder: 'Search notes or topics...',
    },
    // Settings View & Tabs
    settings: {
      title: 'Settings',
